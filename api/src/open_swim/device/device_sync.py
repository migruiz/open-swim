...
from open_swim.device.device_youtube_sync import sync_device_playlists_videos
from open_swim.device.device_playlist_dirs_sync import sync_playlists_directories
